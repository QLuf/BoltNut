...
public class Bar : MonoBehaviour
{
    ...
    private void SetState(int amountBolt, Rigidbody2D connectedRigid2D, Vector3 newPos)
    {
        switch (amountBolt)
        {
            case 0:
    ...
    public void AddBolt(Bolt bolt, Vector3 newPos)
    {
        //Debug.Log("AddBolt");
        if (bolts.Count == 0)
        {
    ...
    public void Init(Vector2 position, Vector3 angle, bool actived)
    {
