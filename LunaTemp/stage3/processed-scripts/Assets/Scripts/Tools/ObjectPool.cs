...
public sealed class ObjectPool : MonoBehaviour
{
    ...
    public static T Spawn<T>(T prefab, Transform parent, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation) where T : Component
    {
        return Spawn(prefab.gameObject, parent, position, rotation).GetComponent<T>();
    }
    public static T Spawn<T>(T prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation) where T : Component
    {
        return Spawn(prefab.gameObject, null, position, rotation).GetComponent<T>();
    }
    public static T Spawn<T>(T prefab, Transform parent, [Bridge.Ref] Vector3 position) where T : Component
    {
        return Spawn(prefab.gameObject, parent, position, Quaternion.identity).GetComponent<T>();
    }
    public static T Spawn<T>(T prefab, [Bridge.Ref] Vector3 position) where T : Component
    {
    ...
    public static GameObject Spawn(GameObject prefab, Transform parent, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
    {
    ...
    public static GameObject Spawn(GameObject prefab, Transform parent, [Bridge.Ref] Vector3 position)
    {
        return Spawn(prefab, parent, position, Quaternion.identity);
    }
    public static GameObject Spawn(GameObject prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
    {
    ...
    public static GameObject Spawn(GameObject prefab, [Bridge.Ref] Vector3 position)
    {
